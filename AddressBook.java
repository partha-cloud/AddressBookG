...
public class AddressBook {
    ...
    ArrayList<AddressBook> addressBookNameList = new ArrayList<>();
    ...
    public void newAddressBook()
    {
        ...
        AddressBook addressbook = new AddressBook(userInputBookName);
    ...
    public void displayAddressBook()
    {
        ...
        for (AddressBook addressBookList : addressBookNameList)
        {
